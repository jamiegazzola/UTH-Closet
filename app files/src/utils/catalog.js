export const CATALOG = {
  ...
  clothing: [
    { id: 'c1', name: 'T-Shirt', desc: 'Unisex crew neck, 100% cotton', sizes: ['XS','S','M','L','XL'] },
    { id: 'c2', name: 'Sweatshirt', desc: 'Pullover hoodie, fleece-lined', sizes: ['XS','S','M','L','XL'] },
    { id: 'c3', name: 'Leggings', desc: 'Mid-rise, full length, stretchy', sizes: ['XS','S','M','L','XL'] },
    { id: 'c4', name: 'Sport Bra', desc: 'Medium support, breathable', sizes: ['XS','S','M','L','XL'] },
    { id: 'c5', name: 'Socks 3-Pack', desc: 'Ankle length, mixed colors', sizes: ['S/M','L/XL'] },
    { id: 'c6', name: 'Underwear', desc: 'Cotton basics, assorted styles', sizes: ['XS','S','M','L','XL'] },
    { id: 'c7', name: 'Pajama Set', desc: 'Comfort fit, breathable cotton', sizes: ['XS','S','M','L','XL'] },
  ],
  supplies: [
    ...
    { id: 'p5', name: 'Backpack', desc: 'Durable 20L, multiple colors', sizes: null },
  ],
}

export const CATEGORIES = [
  { key: 'snacks',     label: 'Snacks',     emoji: '🥜', color: '#FF9E1B' },
  { key: 'essentials', label: 'Essentials', emoji: '🧴', color: '#32BCAD' },
  { key: 'health',     label: 'Health',     emoji: '💊', color: '#D0006F' },
  { key: 'clothing',   label: 'Clothing',   emoji: '👕', color: '#642F6C' },
  { key: 'supplies',   label: 'Supplies',   emoji: '📚', color: '#003865' },
]
